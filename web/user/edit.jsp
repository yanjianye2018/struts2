...
<body>
<s:form action="user_edit" namespace="/" theme="simple" enctype="multipart/form-data">
	&nbsp;
	<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
		...
		<tr>
			...
			<td class="ta_01" bgColor="#ffffff">
				<s:password name="loginpass" showPassword="true"/>
			</td>
			<td align="center" bgColor="#f5fafe" class="ta_01">
				用户姓名：
			</td>
		...
		<tr>
			...
			<td class="ta_01" bgColor="#ffffff">
				<s:select headerKey="" headerValue="==选择学历==" list="{'博士','硕士','研究生','本科','专科','高中'}" name="education" />
			</td>
		</tr>
		<tr>
			<td align="center" bgColor="#f5fafe" class="ta_01">
			...
			<td class="ta_01" bgColor="#ffffff">
				<s:textfield name="birthday" readonly="readonly" size="20" id="birthday"/>
			</td>
			<td align="center" bgColor="#f5fafe" class="ta_01">
				电话：
			</td>
		...
		<tr>
			...
			<td class="ta_01" bgColor="#ffffff" colSpan="3">
				<s:checkboxlist value="hobby.split(', ')" list="{'看电影', '旅游', '健身', '购物', '睡觉', '读书'}" name="hobby"/>
			</td>
		</tr>
		<tr>
			<td align="center" bgColor="#f5fafe" class="ta_01">
		...
		<TR>
			...
			<TD class="ta_01" bgColor="#ffffff" colSpan="3">
				<s:textarea name="remark" cols="30" rows="3" cssStyle="WIDTH: 96%" />
			</TD>
		</TR>
		<TR>
